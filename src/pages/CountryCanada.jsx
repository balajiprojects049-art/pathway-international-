...
import heroSlideCanada2 from '../assets/images/hero_slide_canada_2.png';
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-16 h-full flex items-center relative z-10 pt-20">
                    ...
                    >
                        <div className="flex items-center gap-4 mb-6">
                            <img src="https://flagcdn.com/w160/ca.png" alt="Canada Flag" className="h-16 md:h-20 w-auto object-contain drop-shadow-md" />
